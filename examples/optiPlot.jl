...
[ plot(t_x, x2sol, "--",linewidth=.7) for (x1sol, x2sol) in sols]
plot(t_x, μ2)
plot(t_x, x2max*ones(size(t_x)), "--r",linewidth=2)
#subplot(1,2,2)
#grid(true)
...
fig2 = figure(2, frameon=true, tight_layout=true, figsize=(3.6, 1.8))
subplot(1,2,1)
xgrid = 0:0.001:1
